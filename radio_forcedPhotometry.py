...
def main(incatname, intmap, noisemap, aperture):
...
if __name__ == "__main__":
    ...
    parser.add_argument('aperture',     type=int,    help = 'Aperture radius in arcsec')
    args = parser.parse_args()
       
    main(args.catalogue, args.intmap, args.noisemap, args.aperture)
